...
running command...
$ starlight (--version)
@starlightcms/cli/0.4.0 darwin-arm64 node-v16.16.0
...
_See code: [dist/commands/create.ts](https://github.com/lucas-varela/cli/blob/v0.4.0/dist/commands/create.ts)_
...
_See code: [dist/commands/login.ts](https://github.com/lucas-varela/cli/blob/v0.4.0/dist/commands/login.ts)_
...
_See code: [dist/commands/logout.ts](https://github.com/lucas-varela/cli/blob/v0.4.0/dist/commands/logout.ts)_
...
_See code: [dist/commands/template/import.ts](https://github.com/lucas-varela/cli/blob/v0.4.0/dist/commands/template/import.ts)_
...
_See code: [dist/commands/template/validate.ts](https://github.com/lucas-varela/cli/blob/v0.4.0/dist/commands/template/validate.ts)_
<!-- commandsstop -->
